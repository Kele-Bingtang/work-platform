  ...
  >
    <el-aside>
      <div class="logo flx-center" @click="router.push(HOME_URL)">
        <img src="@work/static/images/logo.png" alt="logo" v-if="settingsStore.showLayoutLogo" />
...
import { useLayoutStore, useErrorLogStore, useSettingsStore, DeviceType } from "@/stores";

...
import type { VNode, ComputedRef, ComponentPublicInstance, ExtractPropTypes, InjectionKey, Ref, Component } from "vue";
...
export interface FormSchemaProps<T = any> {
   ...
   */
  label: ValueType | ((model: T) => ValueType | any) | ComputedRef<ValueType>;
  /**
   * 使用的表单组件名
   */
  el?: FormType;

...
export const closeDrawer = () => {
  const vm = document.querySelector(`#work-drawer-${id.value}`) as Element;
...
export const showDrawer = (
  ...
  const vm = (
    <div id={`work-drawer-${++id.value}`} key={id.value}>
      <ElDrawer modelValue title="弹框" size="30%" before-close={() => handleClose(drawerProps)} {...drawerProps}>
        {{
          default: () => {

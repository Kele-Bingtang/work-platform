...
CREATE TABLE `t_dict_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_project` (
  ...
  `database_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '数据库名称',
  `create_by` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '创建人',
  `create_by_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '创建人 ID',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '更新人',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_project_member` (
  ...
  `team_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '团队 ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目成员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_team_member` VALUES (1,'100338','k100338',NULL,1,1,'刘世鹏','k100338','2024-06-22 23:24:36','刘世鹏','k100338','2024-06-23 21:11:36',1,0,'1804535966066860034'),(2,'100338','k100338',NULL,1,1,'刘世鹏','k100338','2024-06-23 21:12:12','刘世鹏','k100338','2024-06-23 21:12:12',1,1,'1804865036159889410');
...
INSERT INTO `t_user` VALUES (1,'100338','k100338','刘世鹏','$2a$10$KuLstWV.3ER9B3rL8l64huUdewsMeeOFqEHK33ijh8IooSb6ukn/2','2456019588@qq.com',0,'1999.07.27','13377492843',1,NULL,'2024-06-22 09:28:12','0:0:0:0:0:0:0:1','2024-06-27 23:13:13',NULL,NULL,NULL,'刘世鹏','k100338','2024-06-27 23:13:13',1,0);
...
-- Dump completed on 2024-06-28  2:39:07

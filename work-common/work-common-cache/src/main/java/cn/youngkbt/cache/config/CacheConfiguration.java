...
public class CacheConfiguration {
    ...
    public Cache<Object, Object> caffeine(CaffeineCacheProperties properties) {
        return Caffeine.newBuilder()
                // 过期时间
                .expireAfterWrite(properties.getExpire(), TimeUnit.SECONDS)
                // 初始的缓存空间大小
     ...
     */
    @Bean
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory, RedisCacheProperties properties) {
